...
public class CadastroCliente extends javax.swing.JFrame
    ...
    private void initComponents() {
        ...
        txtCnh.setToolTipText("Digite sua CNH");

        txtCpf.setToolTipText("Digite seu CPF");

        txtRg.setToolTipText("Digite seu RG");
        ...
        btnCad.setToolTipText("Clique para cadastrar um novo cliente");
                ...
                .addGroup(pnDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnDadosLayout.createSequentialGroup()
                        ...
                        .addGroup(pnDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCpf, javax.swing.GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
                            .addComponent(txtRg)
                            .addComponent(txtCnh)
    ...
    private void resetaCampos() {
        ...
        txtRg.setForeground(DesignApp.FIELD_FONT_TIP_COLOR);
        txtCpf.setForeground(DesignApp.FIELD_FONT_TIP_COLOR);
        txtCnh.setForeground(DesignApp.FIELD_FONT_TIP_COLOR);
        ...
        txtRg.setText("Ex.: 000000000");
        txtCpf.setText("Ex.: 000000000-00");
        txtCnh.setText("Ex.: 22222222222");
    ...
    private void btnCadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadActionPerformed
        //faz verificacoes antes de add - verify before add 
        if(!placeholderOrEmpty(txtCpf) && Validador.cpfCerto(txtCpf.getText().trim())) { //se cpf nao esta com texto padrao e cpf bate com exp reg
            if(!clienteJaCadastrado(txtCpf.getText().trim())) {
                if(!placeholderOrEmpty(txtNome) && Validador.nomeCerto(txtNome.getText().trim())) { 
                    if(!placeholderOrEmpty(txtTelefone) && Validador.telefoneCerto(txtTelefone.getText().trim())) {
                        if(!placeholderOrEmpty(txtEndereco)) {
                            if(!placeholderOrEmpty(txtEmail) && Validador.emailCerto(txtEmail.getText().trim())) {
                                if(!placeholderOrEmpty(txtRg) && Validador.rgCerto(txtRg.getText().trim())) {
                                    if(!placeholderOrEmpty(txtCnh) && Validador.cnhCerto(txtCnh.getText().trim())) {
                                        if(pwSenha.getForeground() == DesignApp.FIELD_FONT_COLOR 
                                            && pwSenha.getPassword().length > 0) { //se a senha esta preechida - if password is filled
                                            if(Validador.senhaMatches(pwSenha.getPassword(),
                                                ...
                                                if(!emailExiste(txtEmail.getText().trim())) { //se email n existe no bd
                                                    ...
                                                    Cliente cliente = new Cliente(
                                                            ...
                                                            txtRg.getText().trim(), txtCpf.getText().trim(),
                                                            txtCnh.getText().trim(), String.valueOf(pwSenha.getPassword()).trim());

                                                    clienteDao.save(cliente); //salva cliente no bd - save client on db
                                                    ...
                                                    if(IdiomaApp.idiomaAtual == IdiomaApp.PORTUGUES) {
                                                        JOptionPane.showMessageDialog(this, "Cliente cadastrado com sucesso!", 
                                                            "Cliente cadastrado!", JOptionPane.PLAIN_MESSAGE, sucessIcon);
                                                    }else if(IdiomaApp.idiomaAtual == IdiomaApp.INGLES){
                                                        JOptionPane.showMessageDialog(this, "Client succesfully registered!", 
                                                            "Client Registered!", JOptionPane.PLAIN_MESSAGE, sucessIcon);
                                                    }
                                        ...
                                        if(IdiomaApp.idiomaAtual == IdiomaApp.PORTUGUES) {
                                            JOptionPane.showMessageDialog(this, "Erro na CNH do cliente:"
                                                + "\n- Verifique se o campo está vazio;"
                                                + "\n- A CNH deve conter 11 ou 12 dígitos, verifique.",
                                                "Erro na CNH do Cliente", JOptionPane.ERROR_MESSAGE); 
                                        }else if(IdiomaApp.idiomaAtual == IdiomaApp.INGLES) {
                                            JOptionPane.showMessageDialog(this, "Client CNH error:"
                                                + "\n- Verify if CNH field is empty;"
                                                + "\n- Fill out CNH with 11 or 12 characters.",
                                                "Client CNH Error", JOptionPane.ERROR_MESSAGE); 
                                        }
                                    ...
                                    if(IdiomaApp.idiomaAtual == IdiomaApp.PORTUGUES) {
                                        JOptionPane.showMessageDialog(this, "Erro no RG do cliente:"
                                            + "\n- Verifique se o campo está vazio;"
                                            + "\n- Verifique se seu RG está correto",
                                            "Erro no RG do Cliente", JOptionPane.ERROR_MESSAGE); 
                                    }else if(IdiomaApp.idiomaAtual == IdiomaApp.INGLES) {
                                        JOptionPane.showMessageDialog(this, "Client RG error:"
                                            + "\n- Verify if RG field is empty;"
                                            + "\n- Verify if RG was filled out right.",
                                            "Client RG Error", JOptionPane.ERROR_MESSAGE); 
                                    }
                                ...
                                if(IdiomaApp.idiomaAtual == IdiomaApp.PORTUGUES) {
                                    JOptionPane.showMessageDialog(this, "Erro no e-mail do cliente:"
                                        + "\n- Verifique se o campo está vazio;"
                                        + "\n- Verifique se seu email está correto",
                                        "Erro no E-mail do Cliente", JOptionPane.ERROR_MESSAGE);
                                }else if(IdiomaApp.idiomaAtual == IdiomaApp.INGLES) {
                                    JOptionPane.showMessageDialog(this, "Client email error:"
                                        + "\n- Verify if email field is empty;"
                                        + "\n- Verify if email was filled out right.",
                                        "Client Email Error", JOptionPane.ERROR_MESSAGE);
                                }
                        ...
                        if(IdiomaApp.idiomaAtual == IdiomaApp.PORTUGUES) {
                            JOptionPane.showMessageDialog(this, "Erro no telefone do cliente:"
                                + "\n- Verifique se o campo está vazio;"
                                + "\n- Preencha o telefone com apenas números. Ex.: 61981828182",
                                "Erro no Telefone do Cliente", JOptionPane.ERROR_MESSAGE);
                        }else if(IdiomaApp.idiomaAtual == IdiomaApp.INGLES) {
                            JOptionPane.showMessageDialog(this, "Client phone error:"
                                + "\n- Verify if phone field is empty;"
                                + "\n- Fill out phone field with numbers only. Ex.: 61981828182",
                                "Client Phone Error", JOptionPane.ERROR_MESSAGE);
                        }
                    ...
                    if(IdiomaApp.idiomaAtual == IdiomaApp.PORTUGUES) {
                        JOptionPane.showMessageDialog(this, "Erro no nome do cliente:"
                            + "\n- Verifique se o campo está vazio;"
                            + "\n- O nome deve conter somente letras e espaços não duplicados;"
                            + "\n- Verifique se o nome possui espaços duplicados, deixe apenas um.",
                            "Erro no Nome do Cliente", JOptionPane.ERROR_MESSAGE);
                    }else if(IdiomaApp.idiomaAtual == IdiomaApp.INGLES) {
                        JOptionPane.showMessageDialog(this, "Client name error:"
                            ...
                            "Client Name Error", JOptionPane.ERROR_MESSAGE);
                    }
                ...
                if(IdiomaApp.idiomaAtual == IdiomaApp.PORTUGUES) {
                    ...
                    JOptionPane.showMessageDialog(this, "Client already registered!",
                        "Client already Registered", JOptionPane.ERROR_MESSAGE);
                }  
            ...
            if(IdiomaApp.idiomaAtual == IdiomaApp.PORTUGUES) {
                JOptionPane.showMessageDialog(this, "Erro no CPF do cliente:"
                    + "\n- Verifique se o campo está vazio;"
                    + "\n- Digite o CPF com apenas números",
                    "Erro no CPF do Cliente", JOptionPane.ERROR_MESSAGE);
            }else if(IdiomaApp.idiomaAtual == IdiomaApp.INGLES) {
                JOptionPane.showMessageDialog(this, "Client CPF error:"
                    + "\n- Verify if CPF field is empty;"
                    + "\n- Type CPF with numbers only",
                    "Client CPF Error:", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private boolean allFieldsSelected() { //se tudo nao estiver vazio - if everything was not empty
        
        return txtNome.getForeground() == DesignApp.FIELD_FONT_COLOR
                && txtTelefone.getForeground() == DesignApp.FIELD_FONT_COLOR
                && txtEmail.getForeground() == DesignApp.FIELD_FONT_COLOR
                && txtEndereco.getForeground() == DesignApp.FIELD_FONT_COLOR
                && txtRg.getForeground() == DesignApp.FIELD_FONT_COLOR
                && txtCpf.getForeground() == DesignApp.FIELD_FONT_COLOR 
                && txtCnh.getForeground() == DesignApp.FIELD_FONT_COLOR 
                && pwSenha.getForeground() == DesignApp.FIELD_FONT_COLOR 
                && (pwConfSenha.getPassword().length > 0);
//        
...
//            && txtCnh.getText().isEmpty() && (pwSenha.getPassword().length == 0) 
//            && (pwConfSenha.getPassword().length == 0));
    }
    /**
    ...
    public void extraConfigs() {
        ...
        lblRg.setFont(DesignApp.fonteGeral);
        lblCpf.setFont(DesignApp.fonteGeral);
        lblCnh.setFont(DesignApp.fonteGeral);
        ...
        txtEndereco.addFocusListener(new TipNoFocus(txtEndereco, 
                ...
                DesignApp.FIELD_FONT_COLOR,
                DesignApp.FIELD_FONT_TIP_COLOR, 0));
        txtRg.setFont(DesignApp.fonteGeral);
        txtRg.addFocusListener(new TipNoFocus(txtRg, 
                "Ex.: 000000000", 
                DesignApp.FIELD_FONT_COLOR,
                DesignApp.FIELD_FONT_TIP_COLOR, 0));
        txtCpf.setFont(DesignApp.fonteGeral);
        txtCpf.addFocusListener(new TipNoFocus(txtCpf, 
                "Ex.: 000000000-00", 
                DesignApp.FIELD_FONT_COLOR,
                DesignApp.FIELD_FONT_TIP_COLOR, 0));
        txtCnh.setFont(DesignApp.fonteGeral);
        txtCnh.addFocusListener(new TipNoFocus(txtCnh, 
                "Ex.: 22222222222", 
                DesignApp.FIELD_FONT_COLOR,
                DesignApp.FIELD_FONT_TIP_COLOR, 0));
    ...
    public boolean emailExiste(String email) { //verifica se email nao existe no bd - verify if there is no this email inside db
        ...
        for(Cliente c: clienteDao.getAll()) {
            if(c.getEmail().equals(email)) { //se email = a algum existente
                return true;
            }
        }
    ...
    public void resetaListenerCampos() {
        ...
        for(FocusListener focus: txtRg.getFocusListeners()) { //percorre listeneers
            txtRg.removeFocusListener(focus);//remove focus listeners
        }
        
        for(FocusListener focus: txtCpf.getFocusListeners()) { //percorre listeneers
            txtCpf.removeFocusListener(focus);//remove focus listeners
        }
        
        for(FocusListener focus: txtCnh.getFocusListeners()) { //percorre listeneers
            txtCnh.removeFocusListener(focus);//remove focus listeners
        }
    ...
    public void updateLangComponents() {
	    ...
	    setTitle("FastVehicles | Client Registering");
            ...
            txtRg.setToolTipText("Type your RG");
            txtCpf.setToolTipText("Type your CPF");
            txtCnh.setToolTipText("Type your CNH");
            pwSenha.setToolTipText("Type your password");
            pwConfSenha.setToolTipText("Type your password again");
            btnCad.setToolTipText("Press to sign up a new client");
